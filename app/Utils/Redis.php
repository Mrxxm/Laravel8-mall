...
class Redis
{
    ...
    public function zAdd($key, $option, $score1, $value1, $score2 = null, $value2 = null, $scoreN = null, $valueN = null)
    {
        return $this->redis->zAdd($key, $option, $score1, $value1, $score2, $value2);
    }
